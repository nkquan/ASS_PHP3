                                    ...
                                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-1.jpg"
                                                        alt="product">
                                                    <img class="sec-img"
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-2.jpg"
                                                        alt="product">
                                                    <img class="sec-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-17.jpg"
                                                        alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                            ...
                                            <div class="product-caption text-center">
                                                <div class="product-identity">
                                                    <p class="manufacturer-name"><a href="product-details.html">mony</a>
                                                    </p>
                                                </div>
                                                <ul class="color-categories">
                                                    <li>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-3.jpg"
                                                        alt="product">
                                                    <img class="sec-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-16.jpg"
                                                        alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-4.jpg"
                                                        alt="product">
                                                    <img class="sec-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-15.jpg"
                                                        alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-5.jpg"
                                                        alt="product">
                                                    <img class="sec-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-14.jpg"
                                                        alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                    ...
                                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-6.jpg"
                                                        alt="product">
                                                    <img class="sec-img"
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-7.jpg"
                                                        alt="product">
                                                    <img class="sec-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-12.jpg"
                                                        alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-8.jpg"
                                                        alt="product">
                                                    <img class="sec-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-11.jpg"
                                                        alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-9.jpg"
                                                        alt="product">
                                                    <img class="sec-img"
                                                        src="{{ asset('assets/client') }}/img/product/product-10.jpg"
                                                        alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                    ...
                    <div class="col-12">
                        <div class="blog-carousel-active slick-row-10 slick-arrow-style">
                            ...
                            <div class="blog-post-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('assets/client') }}/img/blog/blog-img1.jpg"
                                            alt="blog image">
                                    </a>
                                </figure>
                            ...
                            <div class="blog-post-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('assets/client') }}/img/blog/blog-img2.jpg"
                                            alt="blog image">
                                    </a>
                                </figure>
                                <div class="blog-content">
                            ...
                            <div class="blog-post-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('assets/client') }}/img/blog/blog-img3.jpg"
                                            alt="blog image">
                                    </a>
                                </figure>
                                <div class="blog-content">
                            ...
                            <div class="blog-post-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('assets/client') }}/img/blog/blog-img4.jpg"
                                            alt="blog image">
                                    </a>
                                </figure>
                                <div class="blog-content">
                            ...
                            <div class="blog-post-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html">
                                        <img src="{{ asset('assets/client') }}/img/blog/blog-img5.jpg"
                                            alt="blog image">
                                    </a>
                                </figure>
                                <div class="blog-content">
