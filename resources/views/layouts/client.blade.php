                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="product-large-slider">
                                    ...
                                    <div class="pro-large-img img-zoom">
                                        <img src="{{ asset('assets/client') }}/img/product/product-details-img2.jpg"
                                            alt="product-details" />
                                    </div>
                                    <div class="pro-large-img img-zoom">
                                        <img src="{{ asset('assets/client') }}/img/product/product-details-img3.jpg"
                                            alt="product-details" />
                                    </div>
                                    <div class="pro-large-img img-zoom">
                                        <img src="{{ asset('assets/client') }}/img/product/product-details-img4.jpg"
                                            alt="product-details" />
                                    </div>
                                    <div class="pro-large-img img-zoom">
                                        <img src="{{ asset('assets/client') }}/img/product/product-details-img5.jpg"
                                            alt="product-details" />
                                    </div>
                                </div>
